...
#line 63 "errors.def"
  ERROR_CODE_END_OF_FILE = 37,
#line 64 "errors.def"
  ERROR_CODE_DIRECTORY_NOT_FOUND_ = 38,
#line 65 "errors.def"
  ERROR_CODE_NOT_A_DIRECTORY = 39,
#line 66 "errors.def"
  ERROR_CODE_IO = 40,
#line 69 "errors.def"
  ERROR_CODE_OPEN_DEVICE = 41,
#line 71 "errors.def"
  ERROR_CODE_PARSE_DEVICE_LIST = 42,
#line 72 "errors.def"
  ERROR_CODE_FILE_EXITS = 43,
#line 73 "errors.def"
  ERROR_CODE_FILE_NOT_FOUND = 44,
#line 76 "errors.def"
  ERROR_CODE_HOST_NOT_FOUND = 45,
#line 77 "errors.def"
  ERROR_CODE_CONNECT_FAIL = 46,
#line 80 "errors.def"
  ERROR_CODE_NO_LOGIN_NAME = 47,
#line 81 "errors.def"
  ERROR_CODE_NO_PASSWORD = 48,
#line 82 "errors.def"
  ERROR_CODE_NETWORK_SEND = 49,
#line 83 "errors.def"
  ERROR_CODE_NETWORK_RECEIVE = 50,
#line 84 "errors.def"
  ERROR_CODE_NETWORK_EXECUTE_FAIL = 51,
#line 87 "errors.def"
  ERROR_CODE_INVALID_DEVICE_SPECIFIER = 52,
#line 88 "errors.def"
  ERROR_CODE_LOAD_VOLUME_FAIL = 53,
#line 91 "errors.def"
  ERROR_CODE_PARSE_COMMAND = 54,
#line 92 "errors.def"
  ERROR_CODE_IO_REDIRECT_FAIL = 55,
#line 93 "errors.def"
  ERROR_CODE_FORK_FAIL = 56,
#line 94 "errors.def"
  ERROR_CODE_EXEC_FAIL = 57,
#line 95 "errors.def"
  ERROR_CODE_EXEC_TERMINATE = 58,

  ERROR_CODE_UNKNOWN = 59
} ErrorCodes;
